            ...
            <div className="px-6 -mt-6 relative z-30 flex justify-center md:-mt-20">
                ...
                >
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <Link href="/service-selection" className="bg-primary text-white h-12 rounded-lg font-semibold text-sm flex items-center justify-center gap-2 shadow-lg shadow-primary/30 active:scale-[0.98] transition-all hover:bg-primary-dark">
                            Design Outfit
                        ...
                        <Link href="/designs" className="bg-transparent border border-text-main/20 text-text-main h-12 rounded-lg font-semibold text-sm flex items-center justify-center hover:bg-black/5 active:scale-[0.98] transition-all">
                            Browse Designs
                        </Link>
                    </div>
                </motion.div>
